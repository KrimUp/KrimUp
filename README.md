...
- 🔌 **Datacenter Networks** — designing and building DC-level networks on **Cisco Nexus** (vPC, EVPN/VXLAN, RDMA/RoCEv2)
- 🖥️ **Server Administration** — deploying and tuning **Dell PowerEdge** servers
...
![Cisco](https://img.shields.io/badge/Cisco_Nexus-1BA0D7?style=for-the-badge&logo=cisco&logoColor=white)
![RDMA](https://img.shields.io/badge/RDMA%2FRoCEv2-FF6B35?style=for-the-badge&logo=network-wired&logoColor=white)
...
![Huawei](https://img.shields.io/badge/Huawei_OceanStor-CF0A2C?style=for-the-badge&logo=huawei&logoColor=white)
...
*"If it's not in Ansible, it doesn't exist. If it's not documented, it never happened. If the network is down — nothing else matters anyway."*
